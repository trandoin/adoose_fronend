...
export const verificationMail = (data) =>
  API.post("/user/verificationMail", data);
export const checkLinkValidityVerification = (data) =>
  API.post("/user/checkLinkValidityVerification", data);
...
export const checkLinkValidityForget = (data) =>
  API.post("/user/checkLinkValidityForget", data);
