...
export const checkUsernameAvailability = (data) =>
  API.post("/profile/checkUsernameAvailability", data);
...
export const saveProfession = (data) =>
  API.post("/profile/saveProfession", data);
export const saveAbout = (data) => API.post("/profile/saveAbout", data);
export const saveBriefDetails = (data) =>
  API.post("/profile/saveBriefDetails", data);
...
export const saveSocialMedia = (data) =>
  API.post("/profile/saveSocialMedia", data);
export const saveProfileImage = (data) =>
  API.post("/profile/saveProfileImage", data);
export const saveAccountType = (data) =>
  API.post("/profile/saveAccountType", data);
