...
export const getOthersProfileData = (data) =>
  API.post("/profile/getOthersProfileData", data);
...
export const getLeadsDataPartial = (data) =>
  API.post("/profile/getLeadsDataPartial", data);

export const getPostsData = (data) => API.post("/profile/getPostsData", data);
export const getPostsDataPartial = (data) =>
  API.post("/profile/getPostsDataPartial", data);

export const getFollowData = (data) =>
  API.post("./profile/getFollowData", data);
